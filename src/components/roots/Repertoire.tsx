...
const Repertoire = () => {
    const [movies, setMovies] = useState([{title :"", vote_average: 0, id: "", poster_path: ""}]);
    ...
    return (<div className="grid">
        {movies.map((movie) => <div className="movie-container">
            <h3>{movie.title}</h3>
            ...
            <p className="row-item"><Link className="movie-button-link" to={"/movie/"+movie.id}><Button>Details</Button></Link>
            <Link className="movie-button-link"  to={"/buy/"+movie.id}><Button>Buy</Button></Link></p>
